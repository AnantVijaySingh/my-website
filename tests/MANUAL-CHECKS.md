...
| Page | Additional |
|---|---|
| `index.html` | **No visible page title** — the intro (~60ch) leads; **single-column list of 17 rows**, date at the same size as the title, right-aligned against the titles at ≥768px, **stacked date-above-title at 375px**; no rules between rows; snippets never wider than the reading measure. |
